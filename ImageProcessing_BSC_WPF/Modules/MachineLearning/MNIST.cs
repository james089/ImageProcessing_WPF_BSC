...
namespace ImageProcessing_BSC_WPF.Modules.MachineLearning
{
    public class MNIST
    {
        ...
        public static List<int> Evaluate(DeviceDescriptor device, Bitmap inputImg)
        {
            ...
            return TestHelper.ValidateModelWithSingleImage(modelFile, minibatchSourceExistModel,
                                imageDim, numClasses, featureStreamName, 
